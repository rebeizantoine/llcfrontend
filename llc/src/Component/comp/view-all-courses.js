    ...
    axios
      ...
      .then((response) => {
        ...
        if (course) {
          ...
          axios
            .post(
              `http://localhost:8000/user/postEnrolled/${user_id}/${course_id}`
            )
            .then((response) => {
              console.log(response.data);
              axios
                .get(
                  `http://localhost:8000/user/getEnrolledWhere/${user_id}/${course_id}`
                )
                .then((response) => {
                  ...
                  axios
                    .get(
                      `http://localhost:8000/user/getscheduleWhere/${course_id}`
                    )
                    .then((response) => {
                      ...
                      axios
                        .post(
                          `http://localhost:8000/user/post/${enroll_id}/${schedule_id}`
                        )
                        .then((response) => {
                          console.log(response.data);
                          toast.success(
